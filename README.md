...
[![Version](https://img.shields.io/badge/version-0.1.0--beta.7-blue)](https://github.com/kristhianmanue1/an-kla-memory/releases/tag/v0.1.0-beta.7)
...
`0.1.0b7` y su etiqueta de distribución es `v0.1.0-beta.7`.
...
.venv/bin/python -m an_kla --project-root . upgrade inspect \
  --target v0.1.0-beta.7 > RUTA_EFIMERA_NUEVA
```
