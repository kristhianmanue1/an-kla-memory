...
[![Version](https://img.shields.io/badge/version-0.1.0--beta.5-blue)](https://github.com/kristhianmanue1/an-kla-memory/releases/tag/v0.1.0-beta.5)
...
`0.1.0b5` y su etiqueta de distribución es `v0.1.0-beta.5`.
