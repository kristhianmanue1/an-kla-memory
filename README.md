...
[![Version](https://img.shields.io/badge/version-0.1.0--beta.6-blue)](https://github.com/kristhianmanue1/an-kla-memory/releases/tag/v0.1.0-beta.6)
...
`0.1.0b6` y su etiqueta de distribución es `v0.1.0-beta.6`.
