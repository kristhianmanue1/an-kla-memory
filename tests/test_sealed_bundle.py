...
Particionado en beta.22 (issue #106, plan docs/plans/2026-09-01-deuda-tamanos-adopcion-skevi.md): TestNonceCounterF1 y TestPureFunctions viven ahora en tests/test_sealed_bundle_units.py. Las filas criptográficas (re-ejecutadas por MatrixReRunTests vía _ROW_MODULES) permanecen aquí. Casos y aserciones sin cambios.
"""
