...
class ReleaseGateTests(unittest.TestCase):
    ...
    def test_fails_closed_for_malformed_or_extra_fields(self) -> None:
        cases = (
            ...
            '<!-- an-kla:release-gate {"decision":"proceed","extra":1,"scope":"release-candidate","tag":"v0.1.0-beta.13"} -->',
            '<!-- an-kla:release-gate {"decision":"fix-and-retry","decision":"proceed","scope":"release-candidate","tag":"v0.1.0-beta.13"} -->',
            '<!-- an-kla:release-gate {"decision":"proceed","scope":"PR-C","scope":"release-candidate","tag":"v0.1.0-beta.13"} -->',
            '<!-- an-kla:release-gate {"decision":"proceed","scope":"release-candidate","tag":"v0.1.0-beta.8","tag":"v0.1.0-beta.13"} -->',
        )
        for marker in cases:
