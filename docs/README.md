...
| 0047 | [host-hooks-governed-v1](architecture/0047-host-hooks-governed-v1.md) | G2: hooks gobernados del host (`host-hooks/v1`): declaración read-only `.an-kla/host-hooks.json`, registro de invocaciones acuñado y verificado por el motor (`.an-kla/hook-runs/`), perfil observado en `integration-status-v2` con v1 congelado (#56) | Propuesta | F0 firmada por el maintainer (2026-09-05); spike S1-S3 (`planning/plan-issue-56-g2-spike-s1-2026-09-05.md`, proceed/refine/refine); ronda adversarial pre-code fix-and-retry absorbida (`planning/plan-issue-56-g2-adr0047-adversarial-2026-09-05.md`); implementación F3 pendiente |

Resumen: **47 ADRs**, sin huecos; **43 aceptadas** y **4 propuestas**. No hay
