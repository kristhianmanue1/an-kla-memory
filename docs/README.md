...
| 0036 | [startup-memory-diagnostic-v1](architecture/0036-startup-memory-diagnostic-v1.md) | Diagnóstico de arranque read-only: cuatro estados cerrados para distinguir ausencia de aislamiento | Propuesta | Sin implementación; issue #76, Fase 0 en `main` |
